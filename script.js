// Adhan sound
const adhanSound = new Audio('sound/adhan.mp3');  // Path to your Adhan mp3 file
...
async function getPrayerTimes(location, country, state) {
    try {
        // Make the API request to get the prayer times for the given location
        ...
        // Check if data is available and contains the timings
